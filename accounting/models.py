...
class BangLuong(models.Model):
    ...
    luong_tang_ca = models.DecimalField("Lương tăng ca", max_digits=10, decimal_places=2, default=0)
    phu_cap = models.DecimalField("Phụ cấp", max_digits=10, decimal_places=2, default=0)
    khau_tru = models.DecimalField("Khấu trừ", max_digits=10, decimal_places=2, default=0)
...
class HoaDon(models.Model):
    ...
    trang_thai = models.CharField("Trạng thái", max_length=50, default="Chưa thanh toán") # Ví dụ: Chưa thanh toán, Đã thanh toán, Quá hạn
