        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ky_tinh_luong",
                    models.DateField(
                        verbose_name="Kỳ tính lương (chọn ngày đầu tháng)"
                    ),
                ),
                (
                    "luong_co_ban",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Lương cơ bản"
                    ),
                ),
                (
                    "luong_tang_ca",
                ...
                (
                    "thuc_lanh",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Thực lãnh"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ky_thanh_toan",
                    models.DateField(
                        verbose_name="Kỳ thanh toán (chọn ngày đầu tháng)"
                    ),
                ),
                (
                    "so_tien",
