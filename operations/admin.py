...
class PhanCongCaTrucResource(resources.ModelResource):
    ...
    ngay_truc = resources.Field(
        attribute='ngay_truc',
        column_name='Ngày trực'
    )

    class Meta:
        model = PhanCongCaTruc
        fields = ('id', 'ngay_truc', 'nhan_vien', 'muc_tieu', 'vi_tri_chot', 'ca_lam_viec')
        export_order = ('id', 'ngay_truc', 'nhan_vien', 'muc_tieu', 'vi_tri_chot', 'ca_lam_viec')
...
class ChamCongResource(resources.ModelResource):
    ...
    muc_tieu = resources.Field(attribute='ca_truc__vi_tri_chot__muc_tieu', column_name='Mục tiêu')
    vi_tri_chot = resources.Field(attribute='ca_truc__vi_tri_chot', column_name='Vị trí chốt')
    ca_lam_viec = resources.Field(attribute='ca_truc__ca_lam_viec', column_name='Ca làm việc')
    ngay_truc = resources.Field(attribute='ca_truc__ngay_truc', column_name='Ngày trực')

    class Meta:
        model = ChamCong
        fields = ('id', 'ngay_truc', 'nhan_vien', 'muc_tieu', 'vi_tri_chot', 'ca_lam_viec', 'thoi_gian_check_in', 'thoi_gian_check_out')
        export_order = fields
