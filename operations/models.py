...
class PhanCongCaTruc(models.Model):
    vi_tri_chot = models.ForeignKey(ViTriChot, on_delete=models.CASCADE, verbose_name="Vị trí chốt")
...
class BaoCaoSuCo(models.Model):
    ...
    trang_thai = models.CharField("Trạng thái", max_length=10, choices=TrangThaiBaoCao.choices, default=TrangThaiBaoCao.MOI)
    nguoi_chiu_trach_nhiem = models.ForeignKey(NhanVien, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Người chịu trách nhiệm")
...
class BaoCaoDeXuat(models.Model):
    ...
    nhan_vien = models.ForeignKey(NhanVien, on_delete=models.CASCADE, verbose_name="Người gửi")
